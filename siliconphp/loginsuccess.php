  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <?php if (isset($_SESSION['user'])) { ?>
        <li class="nav-item">
            <a class="nav-link" href="facilitymgmt.php"><b style="color:blue">&ensp;FACILITY</b></a>
        </li>
      <?php }  ?>
<li class="nav-item">
        <a class="nav-link" href="form1.php"><b style="color:blue">&ensp;ADDMISSION</b></a>
      </li>
      <?php if (isset($_SESSION['user'])) { ?>
        <li class="nav-item">
            <a class="nav-link" href="categorymgmt.php"><b style="color:blue">&ensp;CATEGORY</b></a>
        </li>
      <?php }  ?>
      <?php 
      ...
      <?php } else { ?>
        <li class="nav-item">
                <a class="nav-link" href="adminlogin.php"><b style="color:blue">&ensp;ADMIN-LOGIN</b></a>
            </li>       
            <?php } ?>
      ...
      <li class="nav-item dropdown">
        ...
        <?php if (isset($_SESSION['user'])) { ?>
          <a class="dropdown-item" href="dataedit.php">Show Registered List</a>
          <?php }  ?>
...
<?php
    ...
    <form enctype="multipart/form-data" class="well-form-horizontal studentRegistration by-form" action="addhotel.php" method="post" id="contactform">
        <br><br>
